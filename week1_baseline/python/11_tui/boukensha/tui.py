    ...
    **The Repl keeps owning every piece of session logic** — turn counting,
    ...
    def _handle_event(self, event, log):
        ...
        if phase == "iteration":
            ...
            self._live["turn_input_tokens"] += it
            self._live["turn_output_tokens"] += ot
    ...
    def _render_progress(self):
        ...
        if self._live["active"]:
            ...
            widget.update(
                ...
                f"(iter {self._live['iteration']}/{Agent.MAX_ITERATIONS} · {secs}s · "
            ...
            widget.update(
                f"  [ready]   ctx {_fmt_tokens(self._session_input_tokens)}   "
    ...
    def _render_status(self):
        ...
        self.query_one("#status", Static).update(
            f" boukensha v{ver} · {model}  ·  ctx {used}  ·  "
